...
export class LineGraph {
  ...
  private limiteInferiorData: number[] = [];
  private limiteSuperiorData: number[] = [];
  private dataset_important_index = 2;
  ...
  public lineChartData: ChartConfiguration<'line'>['data'] = {
    ...
    datasets: [
      ...
      },
      {
        ...
        pointBorderWidth: 0,
        backgroundColor: 'rgb(254, 0, 0)',
        pointBackgroundColor: 'rgb(254, 0, 0)',
        borderWidth: 1,
        showLine: true,
        animation: false,
        pointRadius: 1
  ...
  reloadData(option: IlineChartConfiguration, vars?: AllVar[], varsName?: string[], allData?: boolean) {
      ...
      if (this.idBlobData) {
        this.blobData.getBlobData(this.idBlobData)
          .then((response) => {
            ...
            let time = 10000; //Valor default de 10 segundos
    ...
    this.lineChartData.datasets[this.dataset_important_index].label = option.general.title;
    this.lineChartData.datasets[this.dataset_important_index].fill = option.styles.fill;
    this.lineChartData.datasets[this.dataset_important_index].backgroundColor = option.styles.fill_color;
    this.lineChartData.datasets[this.dataset_important_index].showLine = option.styles.line;
    this.lineChartData.datasets[this.dataset_important_index].borderColor = option.styles.line_color;
    this.lineChartData.datasets[this.dataset_important_index].borderWidth = option.styles.line_size;
    this.lineChartData.datasets[this.dataset_important_index].tension = option.styles.line_tension;
    this.lineChartData.datasets[this.dataset_important_index].stepped = option.styles.line_stepped;
    this.lineChartData.datasets[this.dataset_important_index].pointStyle = option.styles.point_style;
    this.lineChartData.datasets[this.dataset_important_index].pointBackgroundColor = option.styles.point_color;
    this.lineChartData.datasets[this.dataset_important_index].pointBorderWidth = option.styles.point_border_size;
    this.lineChartData.datasets[this.dataset_important_index].pointBorderColor = option.styles.point_border_color;
    this.lineChartData.datasets[this.dataset_important_index].pointRadius = option.styles.point_width;
